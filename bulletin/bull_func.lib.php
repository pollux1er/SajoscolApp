...
function getGrade($t, $c) {
	if($c == 'F4A' or $c == 'F4B' or $c == 'F5B' or $c == 'F5A') {
		if($t <= 39) 
			return 'U';
		if($t >= 40 and $t <= 44)
			return 'E';
	...
	if($c == 'USS' or $c == 'USA' or $c == 'LSS' or $c == 'LSA') {
		if($t <= 34)
			return 'F';
		if($t >=35  and $t <= 39)
			return '&Phi;';
...
width:".$largeur1."%;\n";
			...
			//-------------------------------
			//////////////////////////////////////////// Header New ///////////////////////////////////////
			echo '<div style="width:750px;border : 1px solid #000000">';
			echo '<div class="school" style="">';
			if($bull_affich_nom_etab=="y"){
				echo '<p class="bulletin"><span class=bgrand>'.$gepiSchoolName."</span></p><br />";
			}
			echo '</div>';
			echo '<div class="armoirie-en" style="">';
			echo "<p class='bulletin'>\n";
			echo '<span class="line1">Republic Of Cameroon</span><br />';
			echo '<span class="line2">Ministry of secondary education</span><br />';
			echo '<span class="line3">PEACE - WORK - FATHERLAND</span>';
			echo "</p>\n";
			echo '</div>';
			echo '<div class="armoirie-fr" style="">';
			echo "<p class='bulletin'>\n";
			echo '<span class="line1">Republique Du Cameroun</span><br />';
			echo '<span class="line2">Ministère de l\'éducation secondaire</span><br />';
			echo '<span class="line3">PAIX - TRAVAIL - PATRIE</span>';
			echo "</p>\n";
			echo '</div>';
			echo '<div class="logo-center" style="">';
			$nom_fic_logo = $logo_etab;
			$nom_fic_logo_c = "../images/".$nom_fic_logo;
			
			if (($nom_fic_logo != '') and (file_exists($nom_fic_logo_c))) {
				echo "<img src=\"".$nom_fic_logo_c."\" border=\"0\" alt=\"Logo\" />";
			} else {
				echo "\n&nbsp;";
			}
			echo "<p class='bulletin'>\n";
			...
			echo '</div>';
			echo '<div class="class-info" style="">';
			if ($tab_bull['affiche_adresse'] != "y") {
			...
			echo '</div>';
			echo '<div class="school-info" style="">';
			echo "<p class='bulletin'>";
			...
			if($bull_affich_adr_etab=="y"){
				...
				echo $gepiSchoolAdress2." ".$gepiSchoolZipCode." ".$gepiSchoolCity;
				

				if($bull_affiche_tel=="y"){echo "<br />\nTel : ".$gepiSchoolTel;}
				if($bull_affiche_fax=="y"){echo "<br />\nFax: ".$gepiSchoolFax;}
				echo "<br />\n Email : info@sajoscol.net";
			}
			echo "</p>\n";
			echo '</div>';
...
//		echo "\n<!-- End of the display of the table of the course of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";
        ...
        if ($bull_affiche_avis == 'y') {
			...
			// 1) l'avis
			echo "<span class='bulletin'><i>Class council decision & discipline / Fee situation :</i></span><br />\n";
			$counted = array_count_values($tab_bull['avis']);
			$result = array();
        ...
        if ($bull_affiche_signature == 'y') {
			...
			*/
			if(isset($tab_bull['eleve'][$i]['pp'][0])) {
				echo "<b style='color:#000'>".ucfirst($gepi_prof_suivi)."</b> ";
				echo "<i style='color:#000'>".affiche_utilisateur($tab_bull['eleve'][$i]['pp'][0]['login'],$tab_bull['eleve'][$i]['id_classe'])."</i>";
		...
		if (($bull_formule_bas != '') and ($bull_affiche_formule == 'y')) {
			...
			echo "<tr>";
			echo "<td><p style='margin:0' align='center' class='bulletin'>".$bull_formule_bas."</p></td>\n";
			echo "</tr></table>";
		}
