 ...
 *******************************************************************/
	...
	if ($_SESSION['statut'] == "administrateur") {
		...
		$menus .= '     <li><a href="'.$gepiPath.'/gestion/changement_d_annee.php">Changing year</a></li>'."\n";
		...
		$menus .= '   </ul>'."\n";
		$menus .= '</li>'."\n";
		$menus .= '<li class="li_inline"><a href="#">&nbsp;Settings</a>'."\n";
		$menus .= '   <ul class="niveau2">'."\n";
		$menus .= '     <li><a href="'.$gepiPath.'/gestion/param_gen.php">General Config</a></li>'."\n";
		...
		$menus .= '     <li><a href="'.$gepiPath.'/gestion/config_prefs.php">Teachers Interface</a></li>'."\n";
		$menus .= '     <li><a href="'.$gepiPath.'/gestion/param_couleurs.php">Colors</a></li>'."\n";
		$menus .= '     <li><a href="'.$gepiPath.'/gestion/param_ordre_item.php">Menus orders</a></li>'."\n";
		$menus .= '   </ul>'."\n";
		$menus .= '</li>'."\n";
		$menus .= '<li class="li_inline"><a href="#">&nbsp;Maintenance</a>'."\n";
		$menus .= '  <ul class="niveau2">'."\n";
		$menus .= '    <li><a href="'.$gepiPath.'/gestion/accueil_sauve.php">Backup</a></li>'."\n";
		$menus .= '    <li><a href="'.$gepiPath.'/utilitaires/maj.php">Mise à jour de la base</a></li>'."\n";
		$menus .= '    <li><a href="'.$gepiPath.'/utilitaires/clean_tables.php">Cleaning the base</a></li>'."\n";
		$menus .= '    <li><a href="'.$gepiPath.'/gestion/efface_base.php">Deleting base</a></li>'."\n";
		$menus .= '    <li><a href="'.$gepiPath.'/gestion/efface_photos.php">Deleting photos</a></li>'."\n";
		$menus .= '    <li><a href="'.$gepiPath.'/gestion/gestion_temp_dir.php">Temp. Folder</a></li>'."\n";
		$menus .= '</ul>'."\n";
		$menus .= '</li>'."\n";
		$menus .= '<li class="li_inline"><a href="#">&nbsp;Data</a>'."\n";
		$menus .= '  <ul class="niveau2">'."\n";
		
		$menus .= '        <li><a href="'.$gepiPath.'/matieres/index.php">Subjects</a></li>'."\n";
		$menus .= '        <li class="plus"><a href="'.$gepiPath.'/utilisateurs/index.php">Users</a>'."\n";
		...
		$menus .= '                <li><a href="'.$gepiPath.'/utilisateurs/edit_eleve.php">Students accounts</a></li>'."\n";
		...
		$menus .= '  <li class="li_inline"><a href="'.$gepiPath.'/gestion/index.php">Security</a>'."\n";
		$menus .= '    <ul class="niveau2">'."\n";
		...
		$tbs_menu_admin[]=array("li"=> '<li class="li_inline"><a href="'.$gepiPath.'/accueil.php">Home</a></li>'."\n");
